...
use Ipasspay\AirsecurecardChannel\service\AirsecurecardService;
    ...
    //2.For more details about the parameters, please refer to the API doc：https://www.apihome.dev/airsecurecard.biz/en-us/#api-other-get_order_list
    ...
    if (!$airsecurecard_service->setConfig($config)->queryOrderList($request_data)) {*/
    if (!$airsecurecard_service->queryOrderList($request_data)) {
