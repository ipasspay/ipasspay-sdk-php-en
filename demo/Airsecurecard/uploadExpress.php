...
use Ipasspay\AirsecurecardChannel\service\AirsecurecardService;
    ...
    //2.For more details about the parameters, please refer to the API doc：https://www.apihome.dev/airsecurecard.biz/en-us/#api-other-tracking
    ...
    if (!$airsecurecard_service->setConfig($config)->uploadExpress($request_data)) {*/
    if (!$airsecurecard_service->uploadExpress($request_data)) {
