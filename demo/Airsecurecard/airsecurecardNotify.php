...
use Ipasspay\AirsecurecardChannel\service\AirsecurecardService;
    ...
    error_log('Verify Signature String：'.$airsecurecard_service->getVerifySignString());
    error_log('Verify Signature：'.$airsecurecard_service->getVerifySign());
    ...
    error_log('The Data in the SDK is：'.json_encode($airsecurecard_service->getNotifyData()));
    //--------------------
    ...
    echo $airsecurecard_service->notifySuccess();
    //echo $airsecurecard_service->notifyFail();
    exit;
