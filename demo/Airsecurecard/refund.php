...
use Ipasspay\AirsecurecardChannel\service\AirsecurecardService;
    ...
    //2.For more details about the parameters, please refer to the API doc：https://www.apihome.dev/airsecurecard.biz/en-us/#api-other-refund
    ...
    if (!$airsecurecard_service->setConfig($config)->refund($request_data)) {*/
    if (!$airsecurecard_service->refund($request_data)) {
